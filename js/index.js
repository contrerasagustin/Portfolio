...
window.onscroll = function () {
    let colorTerciario = "#396EB0";
    let colorCuaternario = "#FC997C"
    var y = window.scrollY;
    let edu = document.querySelector("#divEducation").offsetTop;
    let exp = document.querySelector("#divExperience").offsetTop;
    let ski = document.querySelector("#divSkills").offsetTop;
    let oth = document.querySelector("#divOthers").offsetTop;


    if (y < edu - 150) {
        document.querySelector("#educationLink").style.color = colorTerciario;
        document.querySelector("#experienceLink").style.color = colorTerciario;
        document.querySelector("#skillLink").style.color = colorTerciario;
        document.querySelector("#otherLink").style.color = colorTerciario;
    } else {
        if (y > edu - 150 && y < exp - 150) {
            document.querySelector("#educationLink").style.color = colorCuaternario;
            document.querySelector("#experienceLink").style.color = colorTerciario;
            document.querySelector("#skillLink").style.color = colorTerciario;
            document.querySelector("#otherLink").style.color = colorTerciario;
        } else {
            if (y > exp - 150 && y < ski - 150) {
                document.querySelector("#educationLink").style.color = colorTerciario;
                document.querySelector("#experienceLink").style.color = colorCuaternario;
                document.querySelector("#skillLink").style.color = colorTerciario;
                document.querySelector("#otherLink").style.color = colorTerciario;
            } else {
                if (y > ski - 150 && y < oth - 150) {
                    document.querySelector("#educationLink").style.color = colorTerciario;
                    document.querySelector("#experienceLink").style.color = colorTerciario;
                    document.querySelector("#skillLink").style.color = colorCuaternario;
                    document.querySelector("#otherLink").style.color = colorTerciario;
                } else {
                    document.querySelector("#educationLink").style.color = colorTerciario;
                    document.querySelector("#experienceLink").style.color = colorTerciario;
                    document.querySelector("#skillLink").style.color = colorTerciario;
                    document.querySelector("#otherLink").style.color = colorCuaternario;
                }
            }
        }
    }
    ...
    fetch('../data/profile.json')
        ...
        .then(data => {
            data.forEach(d => {
                ...
                document.getElementsByClassName("name")[0].textContent = d.name;
